...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/donaya365/src/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/donaya365/src/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/donaya365/src/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/donaya365/src/main/ip | grep $MYIP | awk '{print $3}')
fi

wget -q https://raw.githubusercontent.com/donaya365/src/main/about.sh;chmod +x about.sh;./about.sh
...
echo -e " ${RED}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ SUCKER PROJECT ⇲                      \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
