...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/donaya365/src/main/bckp/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/donaya365/src/main/bckp/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/donaya365/src/main/bckp/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/donaya365/src/main/bckp/logcleaner.sh" && chmod +x /usr/bin/cleaner
